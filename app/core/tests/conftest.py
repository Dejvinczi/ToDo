...
def create_user(db, django_user_model):
    ...
    def make_user(email='tesuser@example.com', password='testuserpass',
                  **kwargs):
...
def create_superuser(db, django_user_model):
    ...
    def make_superuser(email='testsuperuser@example.com',
                       password='testsuperuserpass',
                       **kwargs):
        return django_user_model.objects.create_superuser(email, password,
                                                          **kwargs)
